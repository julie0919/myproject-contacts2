...
import com.julie.pms.table.CompanyTable;
import com.julie.pms.table.DataTable;
import com.julie.pms.table.FamilyTable;
import com.julie.pms.table.SchoolTable;
...
public class ServerApp {
  ...
  public void service() {
    ...
    tableMap.put("family/", new FamilyTable());
    tableMap.put("school/", new SchoolTable());
    tableMap.put("company/", new CompanyTable());
  ...
  private void processRequest(Socket socket) {
    try (DataOutputStream out = new DataOutputStream(socket.getOutputStream());
      ...
      while (true) {
        ...
        if (request.getCommand().equals("나가기")) {
