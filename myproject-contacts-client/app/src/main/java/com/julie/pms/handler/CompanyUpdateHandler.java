...
public class CompanyUpdateHandler implements Command {
  ...
  public CompanyUpdateHandler(Statement stmt) {
    this.stmt = stmt;
  }
  ...
  public void service() throws Exception {
    ...
    String[] fields = stmt.executeQuery("company/select", Integer.toString(no)).next().split(",");
    ...
    String work = Prompt.printString(String.format("직장(%s)> ", fields[4]));
    ...
    stmt.executeUpdate("company/update", String.format("%d,%s,%s,%s,%s,%s", 
        no, name, tel, mail, work, address));
